import{s as e,a as t,y as n,m as o,i as a,l as r}from"../index.0c94d8a6.js";e("/assets/style.module.ddcbed56.css");const l="host_12vkevj",s="mapsection_12vkevj",i="map_12vkevj",c="instruction_12vkevj",u="codeblock_12vkevj",d="AIzaSyBTdH3AFSWLD3SrgbNqTGoRsg3U6W0qAAg",g={lat:41.7,lng:-71.47},m=[{lat:41.69547509615208,lng:-71.36993408203125},{lat:41.434490308949215,lng:-71.3671875},{lat:41.50857729743936,lng:-71.20513916015625},{lat:41.66923209813446,lng:-71.18435546874998},{lat:41.80245339578072,lng:-71.34365722656248},{lat:41.910875425626266,lng:-71.39034912109373},{lat:42.01299182987659,lng:-71.38760253906248},{lat:42.01299182987659,lng:-71.80508300781248},{lat:41.69957665997156,lng:-71.795654296875},{lat:41.3566211272796,lng:-71.82156249999998},{lat:41.37723402378496,lng:-71.49471923828123},{lat:41.6154423246811,lng:-71.48529052734375},{lat:41.69547509615208,lng:-71.36993408203125}];function p(){const e=t(null),r=t(null);return n(()=>{let t,n;const o=async()=>{Array.from(document.head.querySelectorAll("script")).some(e=>e.src.includes(d))||(await a(`https://maps.googleapis.com/maps/api/js?key=${d}&libraries=geometry`),await a("https://unpkg.com/measuretool-googlemaps-v3")),n||(n=new window.google.maps.Map(e.current,{center:g,zoom:9,clickableIcons:!1,disableDefaultUI:!0,disableDoubleClickZoom:!0,gestureHandling:"none",draggable:!1}),r.current=new window.MeasureTool(n,{contextMenu:!1,unit:"IMPERIAL"}),r.current.start(m),setTimeout(()=>{let t=Array.from(e.current.querySelectorAll("a"));t=t.concat(Array.from(e.current.querySelectorAll('[tabindex="0"]'))),t.forEach(e=>e.setAttribute("tabindex","-1"))},2e3))};if(e.current){t=new IntersectionObserver(e=>{for(const t of e)t.isIntersecting&&o()},{root:null,rootMargin:"0px",threshold:.25}),t.observe(e.current)}return()=>{t&&t.disconnect(),r.current&&r.current.end()}},[]),o`<section class=${l}>
    ...
    </section>`;var c}export default function(){return n(()=>{document.title="Zhenyang Hua"},[]),o`
      <${p}/>
      <${v}/>
      <${$}/>
    `}
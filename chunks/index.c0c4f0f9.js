import{s as e,m as s,b as t,y as a,u as l,e as n}from"../index.e497b724.js";import{f as r}from"./time.daaab1ba.js";e("/assets/style.module.2e651384.css");const i="writings_j5bi2k",c="list_j5bi2k",u="card_j5bi2k";null;const o="card_cwjn7n",$="title_cwjn7n",p="summary_cwjn7n",d="date_cwjn7n",h="readmore_cwjn7n";function f({id:e,class:t,url:a,title:l,summary:n,date:i}){let c=o;return t&&(c=`${c} ${t}`),s`<div id=${e} class=${c}>
      <h2 class=${$}>
        <a href=${a}>${l}</a>
      </h2>
      <p class=${d}>${r(i)}</p>
      ...
      <span><a href=${r}>Next</a></span>
            ...
            ${a}
        `}function k({posts:e}){const[l,n]=t(""),[r,i]=t(null),[c,u]=t(null),o=e.filter(e=>e.title.toLowerCase().includes(l.trim().toLowerCase())).slice(0,5),$=e=>{location.assign(e)};return a(()=>{null!==c&&$(o[c].url)},[c]),s`<div class=${g} onKeyDown=${e=>{let s=r;switch(e.key){case"ArrowDown":e.preventDefault(),s=null===s?0:(s+1)%o.length;break;case"ArrowUp":e.preventDefault(),s=null===s?o.length-1:(s-1+o.length)%o.length;break;case"Enter":e.preventDefault(),u(s);break;case"Escape":e.preventDefault(),s=null}i(s)}} onBlur=${e=>{e.preventDefault(),i(null)}}>
            <div class=${b}>
                <label for="search">Search Article</label>
                <input id="search" type="text" value=${l} onInput=${e=>{n(e.target.value),i(0)}}/>
            </div>
        ...
        </div>`}function x({posts:e,page:t}){return l("Writings"),s`<div class=${i}>
      <${k} posts=${n}/>
      <${v} ...${t}/>
      <div class=${c}>

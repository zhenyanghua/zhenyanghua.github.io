import{s as e,m as s,b as a,y as l,u as t,e as n}from"../index.97203252.js";import{f as r}from"./time.daaab1ba.js";e("/assets/style.module.2e651384.css");const c="writings_j5bi2k",i="list_j5bi2k",u="card_j5bi2k";null;const $="card_cwjn7n",o="title_cwjn7n",p="summary_cwjn7n",d="date_cwjn7n",f="readmore_cwjn7n";function v({id:e,class:a,url:l,title:t,summary:n,date:c}){let i=$;return a&&(i=`${i} ${a}`),s`<div id=${e} class=${i}>
    ...
    </div>`}null;const _="search_1pt434p",b="searchBox_1pt434p",w="hidden_1pt434p",y="active_1pt434p";function g({posts:e}){const[t,n]=a(""),[r,c]=a(null),[i,u]=a(null),$=e.filter(e=>e.title.toLowerCase().includes(t.trim().toLowerCase())).slice(0,5),o=e=>{location.assign(e)};return l(()=>{null!==i&&o($[i].url)},[i]),s`<div class=${_} onKeyDown=${e=>{let s=r;switch(e.key){case"ArrowDown":e.preventDefault(),s=null===s?0:(s+1)%$.length;break;case"ArrowUp":e.preventDefault(),s=null===s?$.length-1:(s-1+$.length)%$.length;break;case"Enter":e.preventDefault(),u(s);break;case"Escape":e.preventDefault(),s=null}c(s)}} onBlur=${e=>{e.preventDefault(),c(null)}}>
            <div class=${b}>

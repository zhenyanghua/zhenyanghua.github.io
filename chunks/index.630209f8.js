import{s as e,m as t,b as s,y as a,u as l,e as n}from"../index.fc5f8f3a.js";import{f as r}from"./time.daaab1ba.js";e("/assets/style.module.2e651384.css");const c="writings_j5bi2k",i="list_j5bi2k",u="card_j5bi2k";null;const o="card_cwjn7n",$="title_cwjn7n",p="summary_cwjn7n",h="date_cwjn7n",f="readmore_cwjn7n";function d({id:e,class:s,url:a,title:l,summary:n,date:c}){let i=o;return s&&(i=`${i} ${s}`),t`<div id=${e} class=${i}>
      <h2 class=${$}>
        <a href=${a}>${l}</a>
      </h2>
      <p class=${h}>${r(c)}</p>
      <p class=${p} dangerouslySetInnerHTML=${{__html:n}}/>
      <p class=${f} aria-label=${"Read more about "+l}>
      ...
      <${g} ...${s}/>
      <div class=${i}>
        ${e.map(e=>t`<${d} id=${e.url} class=${u} key=${e.url} ...${e} url=${e.url+"#maincontent"}/>`)}
      </div>
      <${g} ...${s}/>
    </div>`}export{A as W};
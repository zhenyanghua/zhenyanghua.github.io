 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:e=>e}),S=` ${s} `;class v{constructor(e,t,s,i){this.strings=e,this.values=t,this.type=s,this.processor=i}getHTML(){const e=this.strings.length-1;let t="",n=!1;for(let r=0;r<e;r++){const e=this.strings[r],o=e.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===e.indexOf("--\x3e",o+1);const a=d.exec(e);t+=null===a?e+(n?S:i):e.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+s}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");let t=this.getHTML();return void 0!==y&&(t=y.createHTML(t)),e.innerHTML=t,e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function U(e){let t=O.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},O.set(e.type,t));let i=t.stringsArray.get(e.strings);if(void 0!==i)return i;const n=e.strings.join(s);return i=t.keyString.get(n),void 0===i&&(i=new r(e,e.getTemplateElement()),t.keyString.set(n,i)),t.stringsArray.set(e.strings,i),i}const O=new Map,M=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,s,i){const n=t[0];if("."===n){return new T(e,t.slice(1),s).parts}if("@"===n)return[new A(e,t.slice(1),i.eventContext)];if("?"===n)return[new C(e,t.slice(1),s)];return new x(e,t,s).parts}handleTextExpression(e){return new N(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const j=(e,...t)=>new v(e,t,"html",R)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const Q={};class X extends D{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(Array.isArray(e)){const t=(e,s)=>e.reduceRight(((e,s)=>Array.isArray(s)?t(s,e):(e.add(s),e)),s),s=t(e,new Set),i=[];s.forEach((e=>i.unshift(e))),this._styles=i}else this._styles=void 0===e?[]:[e];this._styles=this._styles.map((e=>{if(e instanceof CSSStyleSheet&&!J){const t=Array.prototype.slice.call(e.cssRules).reduce(((e,t)=>e+t.cssText),"");return new G(String(t),Z)}return e}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?J?this.renderRoot.adoptedStyleSheets=e.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map((e=>e.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==Q&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)})))}render(){return Q}}X.finalized=!0,X.render=(e,s,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const n=i.scopeName,r=M.has(s),o=$&&11===s.nodeType&&!!s.host,a=o&&!F.has(n),l=a?document.createDocumentFragment():s;if(((e,s,i)=>{let n=M.get(s);void 0===n&&(t(s,s.firstChild),M.set(s,n=new N(Object.assign({templateFactory:U},i))),n.appendInto(s)),n.setValue(e),n.commit()})(e,l,Object.assign({templateFactory:q(n)},i)),a){const e=M.get(l);M.delete(l);const i=e.value instanceof _?e.value.template:void 0;L(n,l,i),t(s,s.firstChild),s.appendChild(l),M.set(s,e)}!r&&o&&window.ShadyCSS.styleElement(s.host)};customElements.define("intro-element",class extends X{static get styles(){return K`:host{grid-area:intro;background-color:rgba(255,255,255,.9);max-width:320px;text-align:center;align-self:center;font-size:1.2rem;box-sizing:border-box;height:250px;display:flex;justify-self:center;align-items:center;--leaf-variance:around;--leaf-size:14;--leaf-color:#73CE8F;background-image:paint(leaf);padding:calc(var(--leaf-size) * 4px)}@media (min-width:768px){:host{--leaf-size:16;justify-self:end;margin:0 60px 0 0}}`}render(){return j`<span>This is a space that holds a collection of my personal work and ideas</span>`}});const Y=K`.hidden{position:absolute;left:0;top:-500px;width:1px;height:1px;overflow:hidden}`;customElements.define("nav-element",class extends X{static get styles(){return[Y,K`:host{grid-area:nav;justify-self:end;align-self:center}nav ul{display:flex;list-style-type:none;font-size:1.4rem;text-transform:capitalize;padding-inline-start:0}nav li{margin:0 10px}@media (min-width:768px){nav ul{margin-right:60px}}`]}render(){return j`<nav><h2 class="hidden">Main Navigation</h2><ul><li><a href="/libraries">libraries</a></li><li><a href="/me">me</a></li><li><a href="/site">site</a></li></ul></nav>`}});customElements.define("skip-link",class extends X{static get styles(){return K`:host{display:block}:host a{padding:6px;position:absolute;top:-40px;left:0;color:#fff;border-right:1px solid #fff;border-bottom:1px solid #fff;border-bottom-right-radius:8px;background:#bf1722;-webkit-transition:top 1s ease-out;transition:top 1s ease-out;z-index:100}:host :focus{position:absolute;left:0;top:0;outline-color:transparent;-webkit-transition:top .1s ease-in;transition:top .1s ease-in}`}render(){return j`<a href="#maincontent">skip to main content</a>`}});customElements.define("brand-element",class extends X{static get styles(){return K`:host{display:block;grid-area:brand;justify-self:end;align-self:center;padding-left:10px}`}render(){return j`<h2><a href="/">Zhenyang's Space</a></h2>`}});customElements.define("header-element",class extends X{static get styles(){return K`:host{display:block;background-image:url(/img/header-banner2x.jpg);background-image:-webkit-image-set(url(/img/header-banner1x.jpg) 1x,url(/img/header-banner2x.jpg) 2x);background-image:image-set(url(/img/header-banner1x.jpg) 1x,url(/img/header-banner2x.jpg) 2x);background-repeat:no-repeat;background-position:50% 76px;height:333px}:host header{height:100%;display:grid;grid-template-areas:"brand nav" "intro intro";grid-template-rows:60px 1fr;grid-template-columns:auto 1fr}@media (min-width:768px){:host header{grid-template-areas:"brand nav" ". intro";grid-template-rows:60px 1fr;grid-template-columns:200px 1fr}}`}render(){return j`<header><skip-link></skip-link><brand-element></brand-element><nav-element></nav-element><intro-element></intro-element></header>`}}),async function(){"paintWorklet"in CSS||await import("https://unpkg.com/css-paint-polyfill"),CSS.paintWorklet.addModule("https://unpkg.com/houdini-leaf/worklet.js")}();
